...
# This test follows the pattern we established when testing PostsController. Using  let, we create a my_topic
# variable to use in our tests. We then write two tests to confirm the expected behavior of the index action.
