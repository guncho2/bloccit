...
#
# At #22 and #23, we test to ensure that users are redirected back to the correct view (posts show or topics show)
#  depending on which view they up voted from. We do this by setting request.env["HTTP_REFERER"] to the requesting URL.
